...
@Component({
    selector: 'jhi-district-tpims',
    templateUrl: './district-tpims.component.html'
})
export class DistrictTpimsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.districtService.search({
                ...
                (res: HttpResponse<DistrictTpims[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: DistrictTpims) {
        return item.id;
    }
