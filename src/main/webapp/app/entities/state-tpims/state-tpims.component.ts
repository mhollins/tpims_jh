...
@Component({
    selector: 'jhi-state-tpims',
    templateUrl: './state-tpims.component.html'
})
export class StateTpimsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.stateService.search({
                ...
                (res: HttpResponse<StateTpims[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: StateTpims) {
        return item.id;
    }
