...
describe('Service Tests', () => {
    ...
    describe('AmenitiesTpims Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AmenitiesTpimsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/amenities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AmenitiesTpims', () => {
