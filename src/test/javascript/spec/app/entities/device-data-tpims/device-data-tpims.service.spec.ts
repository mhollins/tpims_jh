...
describe('Service Tests', () => {
    ...
    describe('DeviceDataTpims Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DeviceDataTpimsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/device-data';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DeviceDataTpims', () => {
