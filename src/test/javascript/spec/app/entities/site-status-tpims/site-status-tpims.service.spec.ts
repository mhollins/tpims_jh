...
describe('Service Tests', () => {
    ...
    describe('SiteStatusTpims Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SiteStatusTpimsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/site-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SiteStatusTpims', () => {
